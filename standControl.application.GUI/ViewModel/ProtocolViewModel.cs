...
namespace standControl.application.GUI.ViewModel
{
    class ProtocolViewModel: INotifyPropertyChanged
    {
        ...
        private void WriteVar()
        {
            ...
            MainViewModel.mainModel.speedNom = double.Parse(sSpedNom.Replace('.',','));
            MainViewModel.mainModel.d1In = double.Parse(sD1in.Replace('.', ','));
            MainViewModel.mainModel.d2Out = double.Parse(sD2Out.Replace('.', ','));
            MainViewModel.mainModel.dWork= double.Parse(sDWork.Replace('.', ','));
            MainViewModel.mainModel.Zm1= double.Parse(sZm1.Replace('.', ','));
            MainViewModel.mainModel.Zm2= double.Parse(sZm2.Replace('.', ','));
            MainViewModel.mainModel.ZtempAir = double.Parse(sTempAir.Replace('.', ','));
            MainViewModel.mainModel.bPress = double.Parse(sbPress.Replace('.', ','));
            MainViewModel.mainModel.drivePhase = double.Parse(sDrivePhase.Replace('.', ','));
            MainViewModel.mainModel.drivePow = double.Parse(sDrivePow.Replace('.', ','));
            MainViewModel.mainModel.driveCurr = double.Parse(sDriveCurr.Replace('.', ','));
            MainViewModel.mainModel.driveSpeed = double.Parse(sDriveSpeed.Replace('.', ','));
            MainViewModel.mainModel.driveVolt = double.Parse(sDriveVolt.Replace('.', ','));
            MainViewModel.mainModel.qNom = double.Parse(sQNom.Replace('.', ','));
            MainViewModel.mainModel.hNom = double.Parse(sHNom.Replace('.', ','));
            MainViewModel.mainModel.KPDNom = double.Parse(sKPDNom.Replace('.', ','));
            MainViewModel.mainModel.qNom = double.Parse(sQNom.Replace('.', ','));
            MainViewModel.mainModel.powNom = double.Parse(sPowNom.Replace('.', ','));
            MainViewModel.mainModel.Ksmog = double.Parse(spSmog.Replace('.', ','));
            MainViewModel.mainModel.kVz = double.Parse(skVz.Replace('.', ','));
            MainViewModel.mainModel.pH = double.Parse(spH.Replace('.', ','));
